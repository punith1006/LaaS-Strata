...
def add_cover_page(doc):
    ...
    run = p.add_run("L&D INTERNSHIP PROGRAMME — VIBE-CODING SPECIALIZATION")
    run.font.size = Pt(12)
    run.font.bold = True
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("Product Scaffolding & Agentic Systems")
    run.font.size = Pt(26)
    run.font.bold = True
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("A Refined 15-Day Curriculum for AI-Assisted Full-Stack Engineering")
    run.font.size = Pt(14)
    ...
    meta_data = [
        ("Prepared For:", "B.Tech Cohort (57 Interns, 14 Teams of 4)"),
        ...
        ("Document Version:", "v1.3.0 (Finalized Refinement - June 2026)")
    ]
...
def build_document():
    ...
    curriculum_items = [
        ...
        {"type": "day", "day": "Day 2\n(2.0 Hours)", "title": "Vibe-Coding & Antigravity Setup", "subtopics": [
            "The Vibe-Coding software paradigm", "Downloading and installing Antigravity IDE", "Workspace paths and environment profiles", "Basic command checking & logs verification"
        ...
        {"type": "day", "day": "Day 10\n(1.5 Hours)\n[1h Teach, 0.5h Doubt]", "title": "Multi-Agent Workflows & Orchestrations", "subtopics": [
            "Visual workflow automation using n8n", "Coordinating event-based triggers (webhooks, schedules)", "Chaining inputs/outputs across agents", "Orchestrating agent hierarchies"

/**
 * Script to cleanly delete test student account: student@laas-academy.com
 * Deletes all related records across ALL tables in FK-dependency order.
 * 
 * Usage: npx ts-node scripts/delete-test-student.ts
 */
...
const TEST_EMAIL = 'student@laas-academy.com';

async function main() {
  console.log(`\n========================================`);
  console.log(`Deleting test student: ${TEST_EMAIL}`);
  console.log(`========================================\n`);
  ...
  if (!user) {
    console.log(`❌ User with email "${TEST_EMAIL}" not found. Nothing to delete.`);
    return;
  }
  ...
  console.log('\n========================================');
  console.log('✅ Successfully deleted test student account!');
  console.log('========================================\n');
}
